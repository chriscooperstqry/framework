package nz.co.cjc.base.framework.views;
 ...
 * <p/>
 * RelativeLayout class that supports the Foreground attribute
 * that FrameLayout has. Used to draw selectors over top of content
 */
