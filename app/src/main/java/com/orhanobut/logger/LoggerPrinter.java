...
final class LoggerPrinter implements Printer {
   ...
   */
  private com.orhanobut.logger.Settings settings;
   ...
   */
  @Override public com.orhanobut.logger.Settings init(String tag) {
    if (tag == null) {
    ...
    this.tag = tag;
    this.settings = new com.orhanobut.logger.Settings();
    return settings;
  }
  ...
  private int getStackOffset(StackTraceElement[] trace) {
    for (int i = MIN_STACK_OFFSET; i < trace.length; i++) {
      ...
      if (!name.equals(com.orhanobut.logger.LoggerPrinter.class.getName()) && !name.equals(Logger.class.getName())) {
        return --i;
      }
    }
    return -1;
